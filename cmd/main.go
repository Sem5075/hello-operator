...
import (
	...
	demov1 "github.com/Sem5075/hello-operator/api/v1"
	"github.com/Sem5075/hello-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8bb8d3a2.example.com",
	...
	if err := (&controller.HelloReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "Hello")
		os.Exit(1)
	}
